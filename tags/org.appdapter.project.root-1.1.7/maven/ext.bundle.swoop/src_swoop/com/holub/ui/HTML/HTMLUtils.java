...
class HTMLUtils {
	...
	private static boolean dump_Element(Element element, HTMLPane requester) {
		System.out.println("<" + (element.getAttributes().getAttribute(HTML.Attribute.ENDTAG) != null ? "/" : "") + element.getName() + "> (instanceof " + element.getClass().getName() + ")");
		...
		while (enum_.hasMoreElements()) {
			...
			System.out.println("\t" + attributeName.toString() + "\t-->\t" + attributeValue.toString() + " (" + attributeValue.getClass().getName() + ")");
		}
