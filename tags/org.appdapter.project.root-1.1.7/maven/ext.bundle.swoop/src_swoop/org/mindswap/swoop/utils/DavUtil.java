...
public class DavUtil {
	...
	private static class VisualAuthenticator extends Authenticator {
		protected PasswordAuthentication getPasswordAuthentication() {
			...
			panel.add(password);
			int option = JOptionPane.showConfirmDialog(null, new Object[] { "Host: " + getRequestingHost(), "Realm: " + getRequestingPrompt(), panel }, "Authorization Required",
	...
	private static boolean putString(String data, String url, String username, String password) throws HttpException, IOException {
	...
	public static boolean saveString(String data, String url) throws HttpException, URIException, IOException {
		return saveString(data, url, null, null);
	}

	public static boolean saveString(String data, String url, String username, String password) throws HttpException, URIException, IOException {
		HttpURL httpURL;
		if (url.startsWith("https:"))
			...
			throw new URIException("Can only save to HTTP resources");
