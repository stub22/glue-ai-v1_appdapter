	...
	public int compare(Object o1, Object o2) {
		try {
			...
			if (o1 instanceof URI && o2 instanceof URI) {
				...
				String frag1 = "", frag2 = "";
				if (o1.toString().indexOf("#") >= 0)
					frag1 = o1.toString().substring(o1.toString().indexOf("#") + 1, o1.toString().length());
				else
					frag1 = o1.toString().substring(o1.toString().lastIndexOf("/") + 1, o1.toString().length());
				if (o2.toString().indexOf("#") >= 0)
					frag2 = o2.toString().substring(o2.toString().indexOf("#") + 1, o2.toString().length());
				else
					frag2 = o2.toString().substring(o2.toString().lastIndexOf("/") + 1, o2.toString().length());
				...
				if (ontName1.indexOf(":") >= 0)
					ontName1 = ontName1.substring(ontName1.indexOf(":") + 1, ontName1.length());
				String ontName2 = shortForms.shortForm(uri2);
				if (ontName2.indexOf(":") >= 0)
					ontName1 = ontName2.substring(ontName2.indexOf(":") + 1, ontName2.length());
				cmp = ontName1.compareToIgnoreCase(ontName2);
