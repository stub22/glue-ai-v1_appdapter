...
public class DataValueChecker {
	...
	public static boolean isValidValue(Frame owner, URI uri, String value) {
		...
		//checking for xsd:normalizedString
			...
			if ((value.indexOf(13) != -1) || (value.indexOf(10) != -1) || (value.indexOf(9) != -1))
				valid = false;
			else
				valid = true;
			if (!valid)
		...
		//checking for xsd:negativeInteger
			...
			if (!valid)
				popupError(owner, errorMsg + "negative integer");
		}
		//checking for xsd:nonNegativeInteger
			...
			if (!valid)
				popupError(owner, errorMsg + "non-negative integer");
		}
		//checking for xsd:nonPositiveInteger
			...
			if (!valid)
				popupError(owner, errorMsg + "non-positive integer");
		}
		//checking for xsd:positiveInteger
			...
			if (!valid)
				popupError(owner, errorMsg + "positive integer");
		}
		...
		//checking for RDFLiteral (always true)
			...
			popupError(owner, "We do not recognize this xsd:datatype");
		return valid;
	}
