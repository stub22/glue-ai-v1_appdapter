...
public class Turtle2RDFConverter {
	...
	public static void main(String[] args) {
		String text3 = "@prefix xsd: <http://www.w3.org/2001/XMLSchema#> ." + "@prefix owl: <http://www.w3.org/2002/07/owl#> ." + "@prefix rdfs: <http://www.w3.org/2000/01/rdf-schema#> ."
				+ "@prefix : <http://protege.stanford.edu/plugins/owl/owl-library/koala.owl#> ." + ":Koala     a owl:Class;    rdfs:subClassOf     :Marsupials . ";
