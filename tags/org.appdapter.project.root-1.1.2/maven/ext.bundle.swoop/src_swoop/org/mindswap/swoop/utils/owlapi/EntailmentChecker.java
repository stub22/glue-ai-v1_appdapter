...
public class EntailmentChecker implements OWLObjectVisitor {
	...
	public boolean isEntailed(OWLObject entailment) {
		try {
			if (entailment instanceof OWLClassAxiom)
				((OWLClassAxiom) entailment).accept(this);
			else if (entailment instanceof OWLPropertyAxiom)
				((OWLPropertyAxiom) entailment).accept(this);
			else if (entailment instanceof OWLIndividualAxiom)
				((OWLIndividualAxiom) entailment).accept(this);
