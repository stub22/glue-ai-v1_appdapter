...
public class SaveCheckpointChange extends OntologyChange {
	 ...
	 * @param cause
	 */
	public SaveCheckpointChange(int scope, OWLOntology ontology, URI ontologyURI, OWLEntity entity, URI entityURI, Set wkspcURIs, String rdfCode, String locationURL, String description,
			String snapShot, String timeStamp, OntologyChange cause) {
