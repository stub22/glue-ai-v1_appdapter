...
public class SwoopChange implements Serializable {
	...
	public SwoopChange(String author, URI owlObjectURI, OntologyChange change, String time, String desc, boolean isCommitted, boolean isCheckpointRelated) {
	...
	public Object clone() {
		SwoopChange cloneSwc = new SwoopChange(this.author, this.owlObjectURI, this.change, this.timeStamp, this.desc, this.isCommitted, this.isCheckpointRelated);

		if (this.extraSubjects != null)
			cloneSwc.extraSubjects = this.extraSubjects;
