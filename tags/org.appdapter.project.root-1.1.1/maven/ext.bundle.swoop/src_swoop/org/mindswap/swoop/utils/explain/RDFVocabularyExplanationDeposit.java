...
public class RDFVocabularyExplanationDeposit extends Hashtable implements VocabularyExplanationDeposit {
	...
	private RDFVocabularyExplanationDeposit() throws URISyntaxException {
		...
		add(new RDFVocabularyExplanation(new URI(name), name,
				"<p>The class rdf:XMLLiteral is the class of XML literal values. rdf:XMLLiteral is an instance of rdfs:Datatype and a subclass of rdfs:Literal.</p>", sources_XMLLit, RDF_REF, null));

		name = RDFVocabularyAdapter.RDF + "Property";
		URI[] sources_props = { new URI("http://www.w3.org/TR/rdf-schema/#ch_property") };
		add(new RDFVocabularyExplanation(new URI(name), name, "<p>rdf:Property is the class of RDF properties. rdf:Property is an instance of rdfs:Class.</p>", sources_props, RDF_REF, null));
		// RDF properties

		name = RDFVocabularyAdapter.RDF + "type";
		URI[] sources_type = { new URI("http://www.w3.org/TR/rdf-schema/#ch_type") };
		add(new RDFVocabularyExplanation(new URI(name), name, "<p>rdf:type is an instance of rdf:Property that is used to state that a resource is an instance of a class.</p>"
				+ "<p>A triple of the form:</p>" + "<p>R rdf:type C</p>" + "<p>states that C is an instance of rdfs:Class and R is an instance of C.</p>"
				+ "<p>The rdfs:domain of rdf:type is rdfs:Resource. The rdfs:range of rdf:type is rdfs:Class.</p>", sources_type, RDF_REF, null));

		// RDF container classes
		name = RDFVocabularyAdapter.RDF + "Bag";
		URI[] sources_bag = { new URI("http://www.w3.org/TR/rdf-schema/#ch_bag") };
		add(new RDFVocabularyExplanation(
				new URI(name),
				name,
		...
		add(new RDFVocabularyExplanation(new URI(name), name, "<p>rdf:List is an instance of rdfs:Class that can be used to build descriptions of lists and other list-like structures.</p>",
		...
		add(new RDFVocabularyExplanation(new URI(name), name, "<p>rdf:first is an instance of rdf:Property that can be used to build descriptions of lists and other list-like structures.</p>"
				+ "<p>A triple of the form:</p>" + "<p>L rdf:first O</p>" + "<p>states that there is a first-element relationship between L and O.</p>"
				+ "<p>The rdfs:domain of rdf:first is rdf:List. The rdfs:range of rdf:first is rdfs:Resource.</p>", sources_first, RDF_REF, null));

		name = RDFVocabularyAdapter.RDF + "rest";
		URI[] sources_rest = { new URI("http://www.w3.org/TR/rdf-schema/#ch_rest") };
		add(new RDFVocabularyExplanation(new URI(name), name, "<p>rdf:rest is an instance of rdf:Property that can be used to build descriptions of lists and other list-like structures.</p>"
				+ "<p>A triple of the form:</p>" + "<p>L rdf:rest O</p>" + "<p>states that there is a rest-of-list relationship between L and O.</p>"
				+ "<p>The rdfs:domain of rdf:rest is rdf:List. The rdfs:range of rdf:rest is rdf:List.</p>", sources_rest, RDF_REF, null));

		name = RDFVocabularyAdapter.RDF + "nil";
		URI[] sources_nil = { new URI("http://www.w3.org/TR/rdf-schema/#ch_nil") };
		add(new RDFVocabularyExplanation(new URI(name), name, "<p>The resource rdf:nil is an instance of rdf:List that can be used to represent an empty list or other list-like structure.</p>"
				+ "<p>A triple of the form:</p>" + "<p>L rdf:rest rdf:nil</p>"
				+ "<p>states that L is an instance of rdf:List that has one item; that item can be indicated using the rdf:first property.</p>", sources_nil, RDF_REF, null));
		...
		add(new RDFVocabularyExplanation(new URI(name), name, "<p>rdf:subject is an instance of rdf:Property that is used to state the subject of a statement.</p>" + "<p>A triple of the form:</p>"
				+ "<p>S rdf:subject R</p>" + "<p>states that S is an instance of rdf:Statement and that the subject of S is R.</p>"
				+ "<p>The rdfs:domain of rdf:subject is rdf:Statement. The rdfs:range of rdf:subject is rdfs:Resource.</p>", resources_subj, RDF_REF, null));

		name = RDFVocabularyAdapter.RDF + "predicate";
		URI[] sources_pred = { new URI("http://www.w3.org/TR/rdf-schema/#ch_predicate") };
		add(new RDFVocabularyExplanation(new URI(name), name, "<p>rdf:predicate is an instance of rdf:Property that is used to state the predicate of a statement.</p>"
				+ "<p>A triple of the form:</p>" + "<p>S rdf:predicate P</p>"
				+ "<p>states that S is an instance of rdf:Statement, that P is an instance of rdf:Property and that the predicate of S is P.</p>"
				+ "<p>The rdfs:domain of rdf:predicate is rdf:Statement and the rdfs:range is rdfs:Resource.</p>", sources_pred, RDF_REF, null));

		name = RDFVocabularyAdapter.RDF + "object";
		URI[] sources_obj = { new URI("http://www.w3.org/TR/rdf-schema/#ch_object") };
		add(new RDFVocabularyExplanation(new URI(name), name, "<p>rdf:object is an instance of rdf:Property that is used to state the object of a statement.</p>" + "<p>A triple of the form:</p>"
				+ "<p>S rdf:object O</p>" + "<p>states that S is an instance of rdf:Statement and that the object of S is O.</p>"
				+ "<p>The rdfs:domain of rdf:object is rdf:Statement. The rdfs:range of rdf:object is rdfs:Resource.</p>", sources_obj, RDF_REF, null));
		...
		add(new RDFVocabularyExplanation(
				...
				"<p>rdf:value is an instance of rdf:Property that may be used in describing structured values.</p>"
						...
						+ "<p>The rdfs:domain of rdf:value is rdfs:Resource. The rdfs:range of rdf:value is rdfs:Resource.</p>", sources_value, RDF_REF, null));
	}
