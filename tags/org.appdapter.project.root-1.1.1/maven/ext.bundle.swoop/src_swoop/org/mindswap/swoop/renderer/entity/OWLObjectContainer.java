...
//,OWLExtendedObjectVisitor
{
	...
	public void visit(OWLObject obj) throws OWLException {
		if (obj instanceof OWLClass)
			...
			visit((OWLDataProperty) obj);
		else if (obj instanceof OWLObjectProperty)
			visit((OWLObjectProperty) obj);
		else if (obj instanceof OWLAnnotationProperty)
			visit((OWLAnnotationProperty) obj);
		else if (obj instanceof OWLIndividual)
			visit((OWLIndividual) obj);
		else if (obj instanceof OWLAnd)
			visit((OWLAnd) obj);
		else if (obj instanceof OWLOr)
			visit((OWLOr) obj);
		else if (obj instanceof OWLNot)
			visit((OWLNot) obj);
		else if (obj instanceof OWLDataAllRestriction)
			visit((OWLDataAllRestriction) obj);
		else if (obj instanceof OWLDataSomeRestriction)
			visit((OWLDataSomeRestriction) obj);
		else if (obj instanceof OWLDataValueRestriction)
			visit((OWLDataValueRestriction) obj);
		else if (obj instanceof OWLObjectAllRestriction)
			visit((OWLObjectAllRestriction) obj);
		else if (obj instanceof OWLObjectSomeRestriction)
			visit((OWLObjectSomeRestriction) obj);
		else if (obj instanceof OWLObjectValueRestriction)
			visit((OWLObjectValueRestriction) obj);
		else if (obj instanceof OWLDataCardinalityRestriction)
			visit((OWLDataCardinalityRestriction) obj);
		else if (obj instanceof OWLObjectCardinalityRestriction)
			visit((OWLObjectCardinalityRestriction) obj);
		else if (obj instanceof OWLDataEnumeration)
			visit((OWLDataEnumeration) obj);
		else if (obj instanceof OWLDataPropertyInstance)
			visit((OWLDataPropertyInstance) obj);
		else if (obj instanceof OWLDataPropertyRangeAxiom)
			visit((OWLDataPropertyRangeAxiom) obj);
		else if (obj instanceof OWLDataType)
			visit((OWLDataType) obj);
		else if (obj instanceof OWLDifferentIndividualsAxiom)
			visit((OWLDifferentIndividualsAxiom) obj);
		else if (obj instanceof OWLDisjointClassesAxiom)
			visit((OWLDisjointClassesAxiom) obj);
		else if (obj instanceof OWLEnumeration)
			visit((OWLEnumeration) obj);
		else if (obj instanceof OWLEquivalentClassesAxiom)
			visit((OWLEquivalentClassesAxiom) obj);
		else if (obj instanceof OWLEquivalentPropertiesAxiom)
			visit((OWLEquivalentPropertiesAxiom) obj);
		else if (obj instanceof OWLFunctionalPropertyAxiom)
			visit((OWLFunctionalPropertyAxiom) obj);
		else if (obj instanceof OWLIndividualTypeAssertion)
			visit((OWLIndividualTypeAssertion) obj);
		else if (obj instanceof OWLInversePropertyAxiom)
			visit((OWLInversePropertyAxiom) obj);
		else if (obj instanceof OWLInversePropertyAxiomImpl)
			visit((OWLInversePropertyAxiomImpl) obj);
		else if (obj instanceof OWLInverseFunctionalPropertyAxiom)
			visit((OWLInverseFunctionalPropertyAxiom) obj);
		else if (obj instanceof OWLEquivalentClassesAxiom)
			visit((OWLEquivalentClassesAxiom) obj);
		else if (obj instanceof OWLObjectPropertyInstance)
			visit((OWLObjectPropertyInstance) obj);
		else if (obj instanceof OWLObjectPropertyRangeAxiom)
			visit((OWLObjectPropertyRangeAxiom) obj);
		else if (obj instanceof OWLPropertyDomainAxiom)
			visit((OWLPropertyDomainAxiom) obj);
		else if (obj instanceof OWLSameIndividualsAxiom)
			visit((OWLSameIndividualsAxiom) obj);
		else if (obj instanceof OWLSubClassAxiom)
			visit((OWLSubClassAxiom) obj);
		else if (obj instanceof OWLSubPropertyAxiom)
			visit((OWLSubPropertyAxiom) obj);
		else if (obj instanceof OWLSymmetricPropertyAxiom)
			visit((OWLSymmetricPropertyAxiom) obj);
		else if (obj instanceof OWLTransitivePropertyAxiom)
			visit((OWLTransitivePropertyAxiom) obj);
	}
	...
	public void visit(OWLEquivalentClassesAxiom axiom) throws OWLException {
		...
		for (Iterator it = equClas.iterator(); it.hasNext();) {
			...
			if ((desc instanceof OWLClass) && (((OWLClass) desc).getURI().equals(base.getURI())))
				LHS.addAll(objects);
			else if (desc instanceof OWLClass && LHS.size() == 0)
				LHS.addAll(objects);
			else
				RHS.addAll(objects);
			objects.clear();
