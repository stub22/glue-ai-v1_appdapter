	...
	public static void run(String[] args) throws Exception {
		...
		while (i.hasNext()) {
			...
			if (!processed.contains(cl) && j > 902) {
				...
				// public OWLOntology getModule(Set allAxioms, Set si, Map axSignature, Map sigToAxioms, URI uriOntology, OWLClass cl) 
				...
				OWLOntology module = seg.getOntologyFromAxioms((Set) result);
				...
				moduleSignature = seg.getOntologySignature((Set) result, module);
