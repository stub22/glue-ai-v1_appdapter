...
public class PostProcessor {
	...
	public static void removeW3CJENATestStats(String input, String output, String discardedfile) {
		try {
			...
			String line = null;
			while ((line = reader.readLine()) != null) {
				if ((line.indexOf("http://cvs.sourceforge.net/viewcvs.py/jena/jena2/testing/") != -1) || (line.indexOf("www.w3.org/2002") != -1)
						|| (line.indexOf("http://lists.w3.org/Archives/Public") != -1) || (line.indexOf("http://web3.w3.org/2002") != -1)) {
					collector.write(line);
					collector.newLine();
					continue;
				}
