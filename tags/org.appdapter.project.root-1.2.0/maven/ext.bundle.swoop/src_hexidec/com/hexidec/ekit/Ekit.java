...
public class Ekit extends JFrame implements WindowListener {
	...
	/** Master Constructor
	  ...
	  */
	public Ekit(String sDocument, String sStyleSheet, String sRawDocument, URL urlStyleSheet, boolean includeToolBar, boolean showViewSource, boolean showMenuIcons, boolean editModeExclusive,
			String sLanguage, String sCountry, boolean base64, boolean debugMode, boolean useSpellChecker, boolean multiBar) {
		//		if(useSpellChecker)
		//		{
		...
		//		else
		//		{
		ekitCore = new EkitCore(sDocument, sStyleSheet, sRawDocument, urlStyleSheet, includeToolBar, showViewSource, showMenuIcons, editModeExclusive, sLanguage, sCountry, base64, debugMode, false,
				multiBar);
		//}
	...
	public static void main(String[] args) {
		if (args.length > 0) {
			...
			Ekit ekit = new Ekit(sDocument, sStyleSheet, sRawDocument, urlStyleSheet, includeToolBar, includeViewSource, includeMenuIcons, modeExclusive, sLang, sCtry, base64, debugOn, spellCheck,
					multibar);
		} else {
			Ekit ekit = new Ekit();
		}
