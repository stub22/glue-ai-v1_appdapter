...
public class JRacer {
	...
	void runDLBenchmark() throws IOException, RacerException {
		...
		String[] files = dir.list(new FilenameFilter() {
			public boolean accept(File dir, String name) {
				return dir != null && name.endsWith(".tkb") && name.indexOf("-roles") == -1 && name.indexOf("-cd") == -1 && name.indexOf("pdwq") == -1 && name.indexOf("people") == -1
	...
	void printTBox(String concept) throws Exception {
		if (concept.equals("BOTTOM") || conceptSet.contains(concept))
			return;
