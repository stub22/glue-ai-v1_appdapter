...
public class ObjectString implements ChangeVisitor, OWLObjectVisitor {
	...
	public void visit(AddObjectPropertyInstance event) throws OWLException {
		value = ("AddObjectPropertyInstance(" + getString(event.getSubject()) + ", " + getString(event.getProperty()) + ", " + getString(event.getObject()) + ")");
	}
	...
	public void visit(RemoveDataPropertyInstance event) throws OWLException {
		value = ("RemoveDataPropertyInstance(" + getString(event.getSubject()) + ", " + getString(event.getProperty()) + ", " + getString(event.getObject()) + ")");
	}

	public void visit(RemoveObjectPropertyInstance event) throws OWLException {
		value = ("RemoveObjectPropertyInstance(" + getString(event.getSubject()) + ", " + getString(event.getProperty()) + ", " + getString(event.getObject()) + ")");
	}
	...
	public void visit(RemoveAnnotationInstance event) throws OWLException {
		value = ("RemoveAnnotationInstance (" + getString(event.getSubject()) + ", " + namedString(event.getProperty()) + ", " + event.getContent() + ")");
	}
