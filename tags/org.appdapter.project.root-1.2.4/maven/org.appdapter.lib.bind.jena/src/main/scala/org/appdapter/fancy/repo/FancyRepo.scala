...
// import org.appdapter.impl.store.{DatabaseRepo_BROKER, DatabaseRepoFactoryLoader}
...
trait FancyRepo extends Repo.WithDirectory with ModelClientCore with Loggable {
  ...
  override def getDefaultRdfNodeTranslator: RdfNodeTranslator = getDirModelClientImpl

  override def getFallbackRdfNodeTranslator: RdfNodeTranslator = getDefaultRdfNodeTranslator
