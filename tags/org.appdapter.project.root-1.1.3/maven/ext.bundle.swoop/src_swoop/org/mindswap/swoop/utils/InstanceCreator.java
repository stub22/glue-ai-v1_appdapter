...
public class InstanceCreator {
	...
	private void createEntity(SwoopModel swoopModel, OWLOntology ontology, OWLEntity newEntity, OWLClass parentClass) {
		if (newEntity != null) {
	 ...
	 */
	public void createClassInstance(SwoopModel swoopModel, String instanceURIStr, String parentClassURIStr) throws InstanceCreationException {
	...
	public void createDataPropertyInstance(SwoopModel swoopModel, String subjectURIStr, OWLDataProperty prop, String val) throws InstanceCreationException {
	...
	public void createObjectPropertyInstance(SwoopModel swoopModel, String subjectURIStr, OWLObjectProperty prop, String objectURIStr) throws InstanceCreationException {
	...
	public void createPropertyInstance(SwoopModel swoopModel, String subjectURIStr, String propURIStr, String objectURIStr) throws InstanceCreationException {
	...
	public void createInstances(Frame frame, String[] n3, SwoopModel swoopModel) throws InstanceCreationException {
		...
		for (int i = 0; i < n3.length; i++) {
			...
			if (stmt.getPredicate().equalsIgnoreCase("a")) {
				...
				try {
					createPropertyInstance(swoopModel, stmt.getSubject(), stmt.getPredicate(), stmt.getObject());
				} catch (Exception e) {
					//e.printStackTrace();
					throw new InstanceCreationException(e.getMessage());
				}
