...
// ,OWLExtendedObjectVisitor
{
	...
	public void visit(OWLDataValue cd) throws OWLException { /* do nothing*/
	}
	...
	public void visit(OWLDataType ocdt) throws OWLException { /* do nothing for OWLDataType -- is this correct?? */
	}
