...
public class InteractiveDate extends java.util.Date {
	...
	/** Works like {@link java.util.Date#Date()}.			*/
	public InteractiveDate() {
		super();
	}

	/** Works like {@link java.util.Date#Date(long)}.		*/
	public InteractiveDate(long date) {
		super(date);
	}

	/** Works like {@link java.util.Date#clone}.			*/
	public Object clone() {
		return super.clone();
	}

	/** Works like {@link java.util.Date#getTime}.			*/
	public long getTime() {
		return super.getTime();
	}

	/** Works like {@link java.util.Date#before}.			*/
	public boolean before(Date w) {
		return super.before(w);
	}

	/** Works like {@link java.util.Date#after}.			*/
	public boolean after(Date w) {
		return super.after(w);
	}

	/** Works like {@link java.util.Date#equals}.			*/
	public boolean equals(Object o) {
		return super.equals(o);
	}

	/** Works like {@link java.util.Date#compareTo(Date)}.	*/
	...
	/** Works like {@link java.util.Date#hashCode}.			*/
	public int hashCode() {
		return super.hashCode();
	}

	/** Works like {@link java.util.Date#toString}.			*/
	...
	public JComponent getUi(boolean isReadOnly) {
		...
		ui = (isReadOnly) ? (JComponent) new JLabel(formatter.format(this)) : (JComponent) new Chooser(formatter.format(this));
		ui.setOpaque(false);
		return ui;
	}
	...
	private class Chooser extends JPanel {
		...
		public Chooser(String label) {
			...
			button = new JButton(new ImageIcon(getClass().getClassLoader().getResource(calendarGraphic)));
