...
package org.appdapter.test.scafun


import org.appdapter.demo.JavaCoreferenceDemo.{_}
...
/*	UNCOMMENT THIS DMILES

	class LoEmptyTao[JEZ ] extends JavaEmptyTao[JEZ] { }
	class LoEmptyZen[JET] extends JavaEmptyZen[JET] { }
...
*/
	...
	//UNCOMMENT THIS DMILES class HiEmptyTao[HEZ <: HiEmptyZen[  _ <:  HiEmptyTao [HEZ]]] extends JavaEmptyTao /*[  HEZ]*/{ }
	//UNCOMMENT THIS DMILES class HiEmptyZen[HET <: HiEmptyTao[  _ <:  HiEmptyZen [HET]]] extends JavaEmptyZen /*[  HET]*/ { }
...
/* UNCOMMENT THIS DMILES	abstract class LoSpec {
