...
import net.peruser.core.machine.*;
...
import net.peruser.module.projector.ProjectorUtils;
...
public class XmlServlet extends HttpServlet
{
	...
	private void writeIndividualsAsXML(String modelPath, String clsNS, String clsFrag, OutputStream os) throws Throwable {
		...
		net.peruser.binding.jena.RDQL_Utils.queryOntModelWithRDQLtoWriteXML(mpath, qpath, flavorURI, os);
	}
