...
public class RepoNavigator extends DemoNavigatorCtrl {
     ...
     * @return
     */
    static public <BT extends ScreenBoxImpl, RBT extends RepoBoxImpl> ScreenBoxContextImpl makeBoxContextImpl(Class<BT> regBoxClass, 
    		Class<RBT> repoBoxClass, TriggerImpl regTrigProto, TriggerImpl repoTrigProto) {
        try {
