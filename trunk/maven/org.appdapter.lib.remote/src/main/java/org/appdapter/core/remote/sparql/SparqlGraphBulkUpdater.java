...
public class SparqlGraphBulkUpdater extends SimpleBulkUpdateHandler {
	...
	@Override public void add(Triple[] arg0) {
	...
	@Override public void add(List<Triple> arg0) {
		Graph g = GraphFactory.createPlainGraph();
		for (Triple t : arg0) {
			g.add(t);
		}
	...
	@Override public void add(Iterator<Triple> arg0) {
		Graph g = GraphFactory.createPlainGraph();
		while (arg0.hasNext()) {
			Triple t = arg0.next();
			g.add(t);
	...
	@Override public void add(Graph arg0) {
		add(arg0, false);
	}

	@Override public void add(Graph g, boolean arg1) {
	...
	@Override protected void notifyRemoveAll() {
