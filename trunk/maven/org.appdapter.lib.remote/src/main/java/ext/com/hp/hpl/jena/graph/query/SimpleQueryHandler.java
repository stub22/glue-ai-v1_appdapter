...
public class SimpleQueryHandler implements QueryHandler {
	...
	@Override public BindingQueryPlan prepareBindings(GraphQuery q, Node[] variables) {
		return new SimpleQueryPlan(graph, q, variables);
	}

	@Override public TreeQueryPlan prepareTree(Graph pattern) {
	...
	*/
	@Override public boolean containsNode(Node n) {
	...
	public static SimpleQueryHandler findOrCreate(Graph g) {
		synchronized (grMap) {
