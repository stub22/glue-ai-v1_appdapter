...
public class BufferPipe implements Pipe {
	...
	@Override public void put(Domain d) {
		putAny(d);
	}
	...
	@Override public void close(Exception e) {
	...
	@Override public Domain get() {
		...
		if (!(pending instanceof Domain))
			throw new RuntimeException(pending.getClass().toString());
		try {
