...
package com.appdapter.peru.binding.dom4j;
...
import com.appdapter.peru.core.name.ParsedPair;
...
public class Dom4jDoc extends Doc {
	...
	public Object getCompatibleValue (Config conf) throws Throwable {
		com.appdapter.peru.binding.jena.JenaModelAwareConfig jmac =
				(com.appdapter.peru.binding.jena.JenaModelAwareConfig) conf;
