...
public void propertyChange(PropertyChangeEvent evt) {
  ...
  */
  private void listenToSource() {
    try {
      if (source != null) {
        BeanInfo info = Utility.getPOJOInfo(source.getClass());
    ...
    private void updateScreenBoxPanel() {
      if (objectPanel != null) {
        ...
        if (object == null) {
          ...
          objectPanel.removeAll();
          label = null;
          view = new ScreenBoxedPOJORef(object, true, true, true);
