...
implements PropertyChangeListener, MouseListener, ActionListener, DragGestureListener, Transferable, DragSourceListener {
	 ...
	 */
	public ScreenBoxedPOJORefPanel(DisplayContext context, Object object, boolean showLabel, boolean showIcon, boolean showPropButton, Collection parent) {
		//super(object);
		this.context = context.getNamedObjectCollection();
	...
	public ScreenBoxedPOJORefPanel(POJOAppContext context, Object object, boolean showLabel, boolean showIcon, boolean showPropButton) {
	...
	@Override public void propertyChange(PropertyChangeEvent evt) {
		if (label != null) {
			if (context == null) {
				...
				label.setText(context.getTitleOf(getValue()));
			}
		}
		checkColor();
	}
		...
		if (object != null) {
			...
			if (showLabel) {
				if (context == null) {
					...
					label = new JLabel(context.getTitleOf(object));
				}
				panel.add(label);
			}
