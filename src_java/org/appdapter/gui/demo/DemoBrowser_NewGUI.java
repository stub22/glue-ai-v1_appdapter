 ...
 */
abstract public class DemoBrowser_NewGUI {
	...
	public static void main(String[] args) {
		...
		try {
			...
			DemoBrowser_NewGUI.registerDemo(crtlMaker);
			//frame.setSize(800, 600);
			//org.appdapter.gui.pojo.Utility.centerWindow(frame);
			dnc = DemoBrowser_NewGUI.makeDemoNavigatorCtrl(args, true);
	...
	private static void registerDemo(DemoNavigatorCtrlFactory crtlMaker) {
	...
	public static BaseDemoNavigatorCtrl makeDemoNavigatorCtrl(String[] args, Class<? extends ScreenBoxImpl> boxClass, Class<? extends RepoBoxImpl> repoBoxClass, boolean isExampleCode) {
		...
		BaseDemoNavigatorCtrl tn = new BaseDemoNavigatorCtrl(bctx, tm, (ScreenBoxTreeNodeImpl) rootBTN, dcp);
		return tn;
	}
	...
	*/
	public JPanel getBoxPanel() {
		...
		return (JPanel) getBrowsePanel();
	}

	public BoxPanelSwitchableView getBrowsePanel() {
		if (true)
			throw new AbstractMethodError();
