...
public class DemoBrowser {
	...
	//@todo replace with a Factory-like object
	static DemoNavigatorCtrl myControl;

	public static DemoNavigatorCtrl makeDemoNavigatorCtrl(String[] args) {
		DemoNavigatorCtrl ctrl = myControl.initialize(args);
		return ctrl;
	}

	public static void registerDemo(DemoNavigatorCtrl crtl) {
		myControl = crtl;
	}
