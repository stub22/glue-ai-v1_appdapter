 ...
 */
public class GenericMatrixPanel extends ScreenBoxPanel {
	...
	ListCellRenderer, TableCellRenderer {
		...
		public Class getColumnClass() {
			...
			if (columnClass != null)
				return columnClass;
			return GenericMatrixPanel.this.getTable().getColumnClass(columnNumber);
		}
	...
	public class ModelMatrixTableModel implements TableModel {
		...
		public Object getRowObject(int rowIndex) {
			return GenericMatrixPanel.this.getRowObject(rowIndex);
		}
	...
	public GenericMatrixPanel(Class matrixClass, Class listClass, GetListFromHolder getList, String[] colNames) {
		super();
