...
import org.appdapter.gui.api.TriggerOneScala;
...
public class RepoNavigator extends DemoNavigatorCtrl {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		org.appdapter.gui.api.Utility.theBoxPanelDisplayContext = (BrowsePanelSwitchableViewFromUI) dnc.getBoxPanelTabPane();
		// .main(args);
	...
	static class ScreenModelBox extends RepoModelBoxImpl {
	...
	static class ScreenGraphTrigger extends TriggerOneScala /*
	...
	public static <TBT extends TriggerImpl<BT>, BT extends ScreenBoxImpl<TBT>, TRBT extends TriggerImpl<RBT>, RBT extends RepoBoxImpl<TRBT>> ScreenBoxContextImpl makeBoxContextImpl(
		...
		try {
			...
			BT rootBox = (BT) DemoServiceWrapFuncs.makeTestBoxImpl((Class) regBoxClass, (TBT) regTrigProto, "Root Object");
			bctx.contextualizeAndAttachRootBox(rootBox);

			BootstrapTriggerFactory btf = new BootstrapTriggerFactory();
			btf.attachTrigger(rootBox, (TriggerImpl) new SysTriggers.QuitTrigger(), "quit");

			BT repoBox = (BT) DemoServiceWrapFuncs.makeTestChildBoxImpl(rootBox, (Class) regBoxClass, (TBT) regTrigProto, "repo");
			BT appBox = (BT) DemoServiceWrapFuncs.makeTestChildBoxImpl(rootBox, (Class) regBoxClass, (TBT) regTrigProto, "app");
			BT sysBox = (BT) DemoServiceWrapFuncs.makeTestChildBoxImpl(rootBox, (Class) regBoxClass, (TBT) regTrigProto, "sys");
			...
			if (true) {
				 ...
				 */
				{
					RBT r1Box = (RBT) DemoServiceWrapFuncs.makeTestChildBoxImpl(repoBox, (Class) repoBoxClass, (TBT) repoTrigProto, "h2.td_001");
					...
					r1Box = (RBT) DemoServiceWrapFuncs.makeTestChildBoxImpl(repoBox, (Class) repoBoxClass, (TBT) repoTrigProto, "h2.td_002");
				...
				RBT r2Box = (RBT) DemoServiceWrapFuncs.makeTestChildBoxImpl(repoBox, (Class) repoBoxClass, (TBT) repoTrigProto, "repo_002");
				...
				BT fishBox = (BT) DemoServiceWrapFuncs.makeTestChildBoxImpl(appBox, (Class) regBoxClass, (TBT) regTrigProto, "fishy");
				...
				BT pumappBox = (BT) DemoServiceWrapFuncs.makeTestChildBoxImpl(appBox, (Class) regBoxClass, (TBT) regTrigProto, "pumapp");
				...
				BT buckTreeBox = (BT) DemoServiceWrapFuncs.makeTestChildBoxImpl(appBox, (Class) regBoxClass, (TBT) regTrigProto, "bucksum");
