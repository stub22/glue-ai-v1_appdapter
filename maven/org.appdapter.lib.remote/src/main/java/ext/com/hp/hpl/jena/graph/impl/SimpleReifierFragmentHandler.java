...
public abstract class SimpleReifierFragmentHandler implements ReifierFragmentHandler {
	...
	@Override public boolean clashedWith(Node tag, Node fragmentObject, Triple reified) {
	...
	@Override public Triple reifyIfCompleteQuad(Triple fragment, Node tag, Node object) {
	 ...
	 * @return
	 */
	@Override public Triple removeFragment(Node tag, Triple already, Triple fragment) {
