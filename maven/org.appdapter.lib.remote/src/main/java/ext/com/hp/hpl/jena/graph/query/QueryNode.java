...
public abstract class QueryNode {
	...
	*/
	...
	public static class Fixed extends QueryNode {
		...
		@Override public Node finder(Domain d) {
			return node;
		}

		@Override public boolean matchOrBind(Domain d, Node x) {
	...
	public static class Bind extends QueryNode {
		...
		@Override public boolean mustMatch() {
			return true;
		}
		...
		@Override public boolean match(Domain d, Node value) {
			d.setElement(index, value);
			return true;
		}

		@Override public boolean matchOrBind(Domain d, Node value) {
			d.setElement(index, value);
			return true;
		}
	...
	public static class JustBound extends QueryNode {
		...
		@Override public boolean match(Domain d, Node X) {
