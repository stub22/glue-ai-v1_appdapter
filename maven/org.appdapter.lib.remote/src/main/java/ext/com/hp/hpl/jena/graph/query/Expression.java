...
package ext.com.hp.hpl.jena.graph.query;
...
public interface Expression {
	...
	*/
	public static abstract class Base implements Expression {
		...
		@Override public boolean isApply() {
			return false;
		}
		...
		@Override public String getFun() {
			return null;
		}

		@Override public Expression getArg(int i) {
			return null;
		}
	...
	*/
	public static abstract class Constant extends Base {
		...
		@Override public abstract Object getValue();
	}
	...
	*/
	public static class Fixed extends Constant {
		...
		@Override public Valuator prepare(VariableIndexes vi) {
	...
	*/
	public static abstract class Application extends Base {
		...
		@Override public abstract int argCount();

		@Override public abstract String getFun();

		@Override public abstract Expression getArg(int i);
	}
	...
	*/
	...
	static class Valof implements VariableValues {
		...
		@Override public final Object get(String name) {
	...
	public static class BoolConstant extends Base implements Expression, Valuator {
		...
		@Override public boolean evalBool(IndexValues vv) {
			return value;
		}

		@Override public Object evalObject(IndexValues iv) {
			return getValue();
		}
	}
}
