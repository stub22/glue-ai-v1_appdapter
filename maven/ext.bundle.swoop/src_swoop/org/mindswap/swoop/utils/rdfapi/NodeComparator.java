	...
	public int compare(Object arg0, Object arg1) {
		if (arg0 instanceof Literal) {
			...
			if (arg1 instanceof Resource) {
				...
				if ((SwoopResourceImpl.isAnonymous(resource0)) && !(SwoopResourceImpl.isAnonymous(resource1))) {
					return 1;
				} else if (!(SwoopResourceImpl.isAnonymous(resource0)) && (SwoopResourceImpl.isAnonymous(resource1))) {
					return -1;
				}
				try {
