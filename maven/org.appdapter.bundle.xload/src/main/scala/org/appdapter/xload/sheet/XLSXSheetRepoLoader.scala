...
import org.appdapter.xload.matdat.{SemSheet, MatrixData}
...
object XLSXSheetRepoLoader extends BasicDebugger {
  ...
  final  def readModelSheetXLSX(sheetLocation: String, sheetName: String, nsJavaMap: java.util.Map[String, String], fileModelCLs: java.util.List[ClassLoader]): Model = {
  ...
  final def loadXLSXSheetRepo(sheetLocation: String, namespaceSheetName: String, dirSheetName: String,
